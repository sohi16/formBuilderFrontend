...
const CategorizedQuestion = ({ questionIndex, questionData, updateQuestionData }) => {
    ...
    return (
        <div className="bg-fuchsia-100 p-4 rounded-lg">
            ...
            <button
                ...
                className="mt-4 bg-fuchsia-500 hover:bg-fuchsia-700 text-white py-2 px-4 rounded focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-fuchsia-900"
            >
                Add Item
            </button>
            ...
            <button
                ...
                className="mt-6 bg-fuchsia-500 hover:bg-gray-600 text-white py-2 px-4 rounded focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-fuchsia-500 block mx-auto"
            >
                Save Question
            </button>
        </div>

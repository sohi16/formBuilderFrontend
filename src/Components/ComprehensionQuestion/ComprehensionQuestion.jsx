...
const Comprehension = ({ questionIndex, questionData, updateQuestionData }) => {
    ...
    return (
        <div className="border-1 bg-fuchsia-100 p-4 rounded mb-4">
            
            <label className="block mb-2 text-gray-700 font-bold text-left">Question Instructions:</label>
            <input
                type="text"
                value={instruction}
            ...
            <div className="text-center"> 
                <button onClick={addSubQuestion}
                    className='ml-10 mr-2 bg-fuchsia-500 hover:bg-slate-500 text-white py-2 px-4 rounded focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-fuchsia-500'>
                    Add SubQuestion
                </button>

                <button onClick={handleSaveQestion}
                    className='ml-10 bg-fuchsia-500 hover:bg-slate-500 text-white py-2 px-4 rounded focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-fuchsia-500'>
                    Save question
                </button>
            </div>
        </div>

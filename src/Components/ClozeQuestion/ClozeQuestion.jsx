...
const ClozeQuestion = ({ questionIndex, questionData, updateQuestionData }) => {
    ...
    return (
        <div className="bg-fuchsia-100 p-4 rounded mb-4">
           ...
           <label className="block mb-2 text-gray-700 font-bold text-left">Sentence:</label>
            <div
                ...
                className="block w-full rounded-md bg-white py-2 px-3 mb-4 text-gray-900 shadow-sm focus:ring-indigo-500 focus:border-indigo-500 sm:text-sm "
            /> <h1 className='text-sm text-left'>(Select the word to make it blank and option)</h1>
            ...
            <div className="text-center">
                <button
                    ...
                    className="bg-fuchsia-500 hover:bg-fuchsia-200 text-white py-2 px-4 rounded focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-fuchsia-500 mt-5"
                >
                    Save Question
                </button>
            </div>
